class GadgetsController < ApplicationController
  ...
  def create
    ...
    @gadget.user_id = current_user.id #error salvado
  ...
  def update
    respond_to do |format|
      if @gadget.update(gadget_params)
        format.html { redirect_to mygadgets_path, notice: 'Gadget was successfully updated.' }
  ...
  private
    ...
    def gadget_params
      params.require(:gadget).permit(:nombre, :descripcion, :activado, :user_id, :calendar, :horarios, :push, :chat, :paypal, :promos, :reservasarticulos, :cita_previa, :llamada_telefono)
    end
end
