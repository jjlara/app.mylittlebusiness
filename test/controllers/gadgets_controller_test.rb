...
class GadgetsControllerTest < ActionController::TestCase
  ...
  test "should create gadget" do
    assert_difference('Gadget.count') do
      post :create, gadget: { activado: @gadget.activado, descripcion: @gadget.descripcion, nombre: @gadget.nombre, user_id: @gadget.user_id }
    end
  ...
  test "should update gadget" do
    patch :update, id: @gadget, gadget: { activado: @gadget.activado, descripcion: @gadget.descripcion, nombre: @gadget.nombre, user_id: @gadget.user_id }
    assert_redirected_to gadget_path(assigns(:gadget))
  end
