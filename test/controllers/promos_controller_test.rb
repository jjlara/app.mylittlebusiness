...
class PromosControllerTest < ActionController::TestCase
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post :create, promo: { descripcion: @promo.descripcion, enlace: @promo.enlace, nombre: @promo.nombre, seguir: @promo.seguir, user_id: @promo.user_id }
    end
  ...
  test "should update promo" do
    patch :update, id: @promo, promo: { descripcion: @promo.descripcion, enlace: @promo.enlace, nombre: @promo.nombre, seguir: @promo.seguir, user_id: @promo.user_id }
    assert_redirected_to promo_path(assigns(:promo))
  end
